...
export class PlanComponent implements OnInit {
  ...
  constructor(private param: NavParams, private planService: PlanService, private global: GlobalService){
  ...
  public onChangeLimitedService(){
    this.plan.limitedService = this.global.numberTransform.nullReplaceToZero(this.plan.limitedService);
  }

  public onChangeLimitedProduct(){
    this.plan.limitedProduct = this.global.numberTransform.nullReplaceToZero(this.plan.limitedProduct);
  }

  public onChangeLimitedPackage(){
    this.plan.limitedPackage = this.global.numberTransform.nullReplaceToZero(this.plan.limitedPackage);
  }
