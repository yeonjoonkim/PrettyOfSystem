...
export class GenderSelectionComponent  implements OnInit {
  ...
  public selectedGender: IPairKeyValue = {value: Constant.Default.Gender.Male, key: 'label.name.male'};
  ...
  private convertToGenderType(g: string): Constant.GenderType{
    let result: Constant.GenderType =  g === Constant.Default.Gender.Male ? Constant.Default.Gender.Male
         : g === Constant.Default.Gender.Female ? Constant.Default.Gender.Female
         : g === Constant.Default.Gender.Other ? Constant.Default.Gender.Other
         : g === Constant.Default.Gender.All ? Constant.Default.Gender.All
