...
@Component({
  selector: 'user-parent-signature',
  templateUrl: './user-parent-signature.component.html',
  styleUrls: ['./user-parent-signature.component.scss'],
})
export class UserParentSignatureComponent implements OnInit {
  ...
  public async onSave() {
    if (!this.requesting) {
      ...
      if (before) {
        ...
        after.setting.parentSignature = this.signature;
