...
export class AccessControlService {
  ...
  private isAccessGrant(roleConfig: IRoleConfiguration, accessGrantLevel: number){
    return roleConfig.rate >= accessGrantLevel;
  }

  private isMenuCategoryAccessGranted(category: IMenuCategory, roleConfig: IRoleConfiguration){
