...
export class MassageBodyPainService {
  ...
  public list: NameValuePairType[] = [
    ...
    { name: 'label.title.radiatingpain', value: 'label.title.radiatingpain' },
    ...
    { name: 'label.title.visceralpain', value: 'label.title.visceralpain' },
    { name: 'label.title.somaticpain', value: 'label.title.somaticpain' },
