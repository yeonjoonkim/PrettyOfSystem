...
export class ShopConfigurationService {
  constructor(public global: GlobalService, private systemShop: SystemShopService, private systemShopConfigRepo: SystemShopConfigurationRepositoryService) {}
  ...
  public setDefaultConfig(): IShopConfiguration{
    return {
      ...
      taxNumber: '',
      active: true,
      timezone: Constant.TimeZone.AmericaAnchorage,
      address: {
        street: '',
        suburb: 'SUNNYBANK',
        state: 'QLD',
      ...
      setting: {
        timePicker: {
          intervalMin: Constant.Setting.ShopSetting.TimePicker.intervalMin,
        },
      },
      activeFrom: new Date(),
      activeTo: null
