...
export class FormHeaderComponent implements OnInit {
  ...
  private setDefaultStatus(){
    this.status = this.action === Constant.Default.FormAction.Create ? this.status = Constant.Default.FormStatus.Creating
                : this.action === Constant.Default.FormAction.Edit ? this.status = Constant.Default.FormStatus.Editing
                : this.action === Constant.Default.FormAction.Read ? this.status = Constant.Default.FormStatus.Reading
